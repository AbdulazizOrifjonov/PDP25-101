...
const INITIAL_STUDENTS = [
  { id: 1, name: "AXMADJONOVA MADINABONU", status: "Nomalum", reason: "" },
  { id: 2, name: "BOZOROV BEHRUZ", status: "Nomalum", reason: "" },
  { id: 3, name: "G‘ANIBOYEV FARRUX", status: "Nomalum", reason: "" },
  { id: 4, name: "HASANOV OG‘ABEK", status: "Nomalum", reason: "" },
  { id: 5, name: "IKROMJONOV BOBUR", status: "Nomalum", reason: "" },
  { id: 6, name: "IKROMOV YAHYO", status: "Nomalum", reason: "" },
  { id: 7, name: "ILHOMOV BEHRUZ", status: "Nomalum", reason: "" },
  { id: 8, name: "KURBONOV BEHRUZ", status: "Nomalum", reason: "" },
  { id: 9, name: "MANSUROV MUHAMMADBOBUR", status: "Nomalum", reason: "" },
  { id: 10, name: "MAXMUDOVA MADINAXON", status: "Nomalum", reason: "" },
  { id: 11, name: "MO‘MINOV FOZILJON", status: "Nomalum", reason: "" },
  { id: 12, name: "MURODULLAYEV JAMOLIDDIN", status: "Nomalum", reason: "" },
  { id: 13, name: "MUROTOV UMIDJON", status: "Nomalum", reason: "" },
  { id: 14, name: "NOSIRJONOVA MOHINUR", status: "Nomalum", reason: "" },
  { id: 15, name: "NOZIMOV ABDULLOH", status: "Nomalum", reason: "" },
  { id: 16, name: "ORIFJONOV ABDULAZIZBEK", status: "Nomalum", reason: "" },
  { id: 17, name: "QODIROV MUHAMMADMUSO", status: "Nomalum", reason: "" },
  { id: 18, name: "SOATOV SHOHJAHON", status: "Nomalum", reason: "" },
  { id: 19, name: "SUNNATOV SHERXON", status: "Nomalum", reason: "" },
  { id: 20, name: "SUNNATOV XUSAN", status: "Nomalum", reason: "" },
  { id: 21, name: "TEMIROVA LOLA", status: "Nomalum", reason: "" },
  { id: 22, name: "TULEGENOV AZIZBEK", status: "Nomalum", reason: "" },
  { id: 23, name: "TUYGUNOV ZAMIR", status: "Nomalum", reason: "" },
  { id: 24, name: "URAZBAYEVA DINARA", status: "Nomalum", reason: "" },
  { id: 25, name: "XAKIMOVA MUNISA", status: "Nomalum", reason: "" },
  { id: 26, name: "XOSHIMOV MUHAMMADALI", status: "Nomalum", reason: "" },
  { id: 27, name: "XUSANOV SHAMSIDDIN", status: "Nomalum", reason: "" },
  { id: 28, name: "YO‘LDASHEVA RANO", status: "Nomalum", reason: "" },
];
